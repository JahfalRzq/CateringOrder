            ...
            <div class="container pt-25">
                <div class="row">
                    <div class="col-lg-6 align-self-center mb-lg-0 mb-4">
                        <h6 class="mt-0 mb-15 text-uppercase font-sm text-brand wow fadeIn animated">Our Catering</h6>
            ...
            <div class="container pt-25">
                <div class="row mb-50">
                    <div class="col-lg-12 col-md-12 text-center">
                        ...
                        <p class="w-50 m-auto text-grey-3 wow fadeIn animated">By taking the opportunity to utilize technology in the catering sector, some responses from clients with the steps taken by Difa Catering</p>
                    </div>
                </div>
                <div class="row align-items-center">
