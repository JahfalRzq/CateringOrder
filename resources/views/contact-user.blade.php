            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="/index-user"><img src="assets/imgs/logo/logo.png" alt="logo"></a>
                    </div>
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <div class="shopping-c3art-delete">
                                                    <a href="#"><i class="fi-rs-cross-small"></i></a>
                                                </div>
                                            </li>
                                        </ul>
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="/index-user">Home</a></li>
                            ...
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Our Collections</a>
                                <ul class="dropdown">
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Women's Fashion</a>
                                        <ul class="dropdown">
                                            <li><a href="/product-detail-user">Dresses</a></li>
                                            <li><a href="/product-detail-user">Blouses & Shirts</a></li>
                                            <li><a href="/product-detail-user">Hoodies & Sweatshirts</a></li>
                                            <li><a href="/product-detail-user">Women's Sets</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Men's Fashion</a>
                                        <ul class="dropdown">
                                            <li><a href="/product-detail-user">Jackets</a></li>
                                            <li><a href="/product-detail-user">Casual Faux Leather</a></li>
                                            <li><a href="/product-detail-user">Genuine Leather</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children"><span class="menu-expand"></span><a href="#">Technology</a>
                                        <ul class="dropdown">
                                            <li><a href="/product-detail-user">Gaming Laptops</a></li>
                                            <li><a href="/product-detail-user">Ultraslim Laptops</a></li>
                                            <li><a href="/product-detail-user">Tablets</a></li>
                                            <li><a href="/product-detail-user">Laptop Accessories</a></li>
                                            <li><a href="/product-detail-user">Tablet Accessories</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    <a href="/index-user" rel="nofollow">Home</a>                    
