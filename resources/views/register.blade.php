            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="/s"><img src="assets/imgs/logo/logo.png" alt="logo"></a>
                    </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <li hidden><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                        <ul class="sub-menu">
                            ...
                            <div class="login_wrap widget-taber-content p-30 background-white border-radius-5">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-group">
                                                <a href="/login" type="submit" class="btn btn-fill-out btn-block hover-up" name="register">Register</a>
                                            </div>
                                        </form>                                        
            ...
            <div class="container pt-15 pb-20">
                <div class="row">
                    ...
                    <div class="col-lg-2  col-md-3">
                        ...
                        <ul hidden class="footer-list wow fadeIn animated">
