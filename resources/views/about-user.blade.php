                                        ...
                                        <ul>
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="/product-detail-user"><img alt="Difa Catering" src="assets/imgs/shop-user/thumbnail-3.jpg"></a>
                                                </div>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href="/product-detail-user"><img alt="Difa Catering" src="assets/imgs/shop-user/thumbnail-2.jpg"></a>
                                                </div>
                                                <div class="shopping-cart-title">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="/product-detail-user"><img alt="Difa Catering" src="assets/imgs/shop-user/thumbnail-4.jpg"></a>
                                            </div>
                                            <div class="shopping-cart-title">
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center mb-lg-0 mb-4">
                        ...
                        <h1 class="font-heading mb-40">
                            We Build A Purpose To Advance In The Catering Field
                        </h1>
                        <p>We try to provide the best service as a catering business that keeps up with the times by utilizing technology,so that it is easy to access.</p>
                        <p>By taking advantage of technological developments, it is much easier to enjoy comfort and satisfaction for clients, especially catering. </p>
                    </div>
                    <div class="col-lg-6">
