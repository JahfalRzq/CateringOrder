                                ...
                                <ul>
                                    ...
                                    <li class="position-static"><a href="#">Our Menus <i class="fi-rs-angle-down"></i></a>
                                        <ul class="mega-menu">
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href="/product-detail"><img src="assets/imgs/banner/menu-banner.jpg" alt="Difa Catering"></a>
                                                    <div class="menu-banner-content">
                                                        <h4>Hot deals</h4>
                                                        <h3>Don't miss<br> Trending</h3>
                                                        <div class="menu-banner-price">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="order_review">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5><a href="/product-detail">Yidarton Women Summer Blue</a></h5> <span class="product-qty">x 2</span>
                                            </td>
                                            <td>$180.00</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <h5><a href="/product-detail">LDB MOON Women Summe</a></h5> <span class="product-qty">x 1</span>
                                            </td>
                                            <td>$65.00</td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><i class="ti-check-box font-small text-muted mr-10"></i>
                                                <h5><a href="/product-detail">Women's Short Sleeve Loose</a></h5> <span class="product-qty">x 1</span>
                                            </td>
                                            <td>$35.00</td>
                                        </tr>
                                        <tr>
                            ...
                            <a href="#" class="btn btn-fill-out btn-block mt-30" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Place Order</a>
                        </div>
                    </div>
                </div>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Difa Catering</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        Pesanan Anda Te di Proses
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button hidden type="button" class="btn btn-primary">Understood</button>
      </div>
    </div>
  </div>
</div>
